	...
	<div class="container relative">
		<div class="max-lg:w-2/3 max-md:w-full flex flex-col items-center w-1/2 mx-auto">
			...
			<div class="transition-all delay-[450ms] opacity-0 translate-y-3 group-[.page-loaded]/body:opacity-100 group-[.page-loaded]/body:translate-y-0">
				...
				@else
					<a data-fancybox="video-gallery" style="border-radius: 3rem;" href="{{!empty($fSetting->hero_button_url) ? $fSetting->hero_button_url : '#'}}" class="inline-flex items-center justify-center w-full py-3 px-4 text-lg font-semibold text-white transition-all duration-300 bg-black bg-opacity-10  hover:bg-opacity-20">
						<svg style="padding: 13px; border-radius: 2rem;" xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-player-play-filled bg-white me-4" width="40" height="40" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
