        ...
        <div class="row row-cards">
            ...
            <div class="col-sm-8 col-lg-8">
                ...
                <div class="flex flex-col justify-content-center text-center">
                    ...
                    <form class="" action="{{ route('dashboard.user.payment.iyzico.subscribePay') }}" method="POST">@csrf
                        <input type="hidden" name="planId" value="{{$plan->id}}">
                        <input type="hidden" name="ip" value="{{$_SERVER['REMOTE_ADDR']}}">
                        <input type="hidden" name="iyzicoPriceId" value="{{$iyzicoPriceId}}">
                        <div class="w-full min-h-[400px] flex flex-col sm:flex-row gap-3 ">
                            ...
                            <div class="sm:w-1/2 w-full">
                                <div class="max-w-sm flex flex-col gap-3">
                                    ...
                                    <div class="flex flex-col justify-start text-start">
                                        ...
                                        <input type="text" class="form-control" id="registrationAddress" value="{{old('registrationAddress')}}" name="registrationAddress" required>
                                    </div>
                                    <div class="flex flex-col justify-start text-start">
                        ...
                        <p>
                            <button type="submit" class="btn btn-primary mt-4 w-full">{{__('Continue to Payment')}}</button>
                        </p>
                    ...
                    <p></p>
                    <p class="mt-3">{{__('By purchase you confirm our')}} <a href="{{ url('/').'/terms' }}" target="_blank">{{__('Terms and Conditions')}}</a> </p>
