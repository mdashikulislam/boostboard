            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
                <ul class="primary-nav navbar-nav max-lg:py-4 max-lg:px-3">
                    ...
                    @if(Auth::user()->type == 'admin')
						...
						<li class="nav-item">
							<a class="nav-link {{activeRoute('dashboard.admin.ads.index')}}" href="{{route('dashboard.admin.ads.index')}}">
								<span class="nav-link-icon inline-flex m-1 items-center border border-dark p-0 justify-center stroke-width='1.5' w-[15px] h-[15px] shrink-0 rounded-[6px] bg-[#ffffff] text-dark text-[13px] font-normal">
									{{mb_substr(__('Google'), 0, 1)}}
								</span>
								<span class="flex ms-1 items-center transition-[opacity,transform] nav-link-title grow">
									{{__('Google Adsense')}}
								</span>
							</a>
						</li>
						...
						@includeWhen(view()->exists('panel.admin.custom.header-menu'), 'panel.admin.custom.header-menu')
