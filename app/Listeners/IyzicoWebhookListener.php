...
class IyzicoWebhookListener implements ShouldQueue
{
    ...
    public function handle(IyzicoWebhookEvent $event): void
    {
        ...
        try{
            ...
            // Incoming data is verified at IyzicoController handleWebhook function, which fires this event.
...
*/
            ...
            if($event_type == 'subscription.order.failure'){
                ...
                if(IyzicoController::getSubscriptionStatus() == true){
            ...
            $newData->save();
            //error_log("IyzicoWebhookListener::handle()\n".$ex->getMessage());
        }
    }
